...
ADMINS = [("Runyu Ding", "runyud@gmail.com")]
...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["traningwebdev.com"])

ADMIN_URL = env("DJANGO_ADMIN_URL")

DATABASES = {"default": env.db("DATABSE_URL")}
...
SITE_NAME = "Artcles Blog"

SERVER_EMAIL = env("DJANGO_SERVER_EMAIL", default=DEFAULT_FROM_EMAIL)

EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default="[Articles Blog]")
